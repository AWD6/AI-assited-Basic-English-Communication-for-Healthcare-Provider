...
const defaultScenarios = [
  ...
  },
  {
    ...
    phrases: [
      ...
      { id:'d11', en:'Please collect your special examination appointment on the second floor of Sriphat Building.', th:'กรุณารับใบนัดตรวจพิเศษต่างๆ ที่ชั้น 2 อาคารศรีพัฒน์ค่ะ', zh:'请到 Sriphat 大楼二楼领取特殊检查预约单。', phonetic_en:'พลีส คัลเลค ยอร์ สเปเชียล เอ็กซามิเนชัน อะพ็อยน์เมนท์ ออน เดอะ เซคเคินด์ ฟลอร์ ออฟ ศรีพัฒน์ บิลดิ้ง', phonetic_zh:'ฉิ่ง ต้าว Sriphat ต้าโหลว เอ้อร์โหลว หลิงชู่ เทอซู่ เจี่ยนฉา ยู้เยวียตาน', context:'Directing to special appointment desk', contextTh:'บอกทางไปรับใบนัดตรวจพิเศษ' },
